...
#    Updated: 2019/07/02 16:20:15 by jmondino         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = ft_ls

SRC = src/acl.c src/add_new_entry.c src/column.c src/column_aux.c src/display.c src/fill_list.c src/free.c src/main.c src/offsets.c src/parsing.c src/parsing_aux.c src/print_color.c src/print_l.c src/print_l_aux.c src/recursive.c src/sort_list.c src/sort_list_aux.c src/sort_tab.c src/xattr.c src/add_new_entry_aux.c
