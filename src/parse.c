...
/*   Updated: 2019/06/26 20:34:14 by jmondino         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_existent(char *str, t_shit *pShit)
{
	...
	if (S_ISREG(pStat.st_mode) || S_ISLNK(pStat.st_mode) || S_ISBLK(pStat.st_mode)
		|| S_ISFIFO(pStat.st_mode) || S_ISCHR(pStat.st_mode) 
